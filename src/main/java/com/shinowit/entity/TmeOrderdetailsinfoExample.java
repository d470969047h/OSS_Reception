...
public class TmeOrderdetailsinfoExample {
    /**
     ...
     * @mbggenerated Mon Dec 29 09:58:42 CST 2014
     */
    public TmeOrderdetailsinfoExample() {
    ...
    public TmeOrderdetailsinfoExample(int pageSize, int pageIndex) {
        this();
        this.pageSize=pageSize;
        this.pageIndex=pageIndex;
    }
     ...
     * This class corresponds to the database table TMe_OrderDetailsInfo
     *
     * @mbggenerated do_not_delete_during_merge Mon Dec 29 09:58:42 CST 2014
     */
