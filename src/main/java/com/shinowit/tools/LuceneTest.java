...
//    }
//
//    public void createIndex(List<TmeMerchandiseinfo> list) throws Exception {
...
////        merchandiseinfoExample.setPageSize(8);
////        merchandiseinfoExample.setPageIndex(1);
...
//
//        for (TmeMerchandiseinfo detail : list) {
////            if (merchandiseinfoList[i].isFile() && merchandiseinfoList[i].getName().endsWith(".txt")) {
////                System.out.println("Indexing file " + merchandiseinfoList[i].getCanonicalPath());
