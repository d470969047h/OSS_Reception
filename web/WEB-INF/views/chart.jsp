...
<div id="body">
    <div id="Login">
        <DIV id="gwc">
            <DIV class="mcar" style="width:774px; margin:auto"><IMG alt=我的购物车 src="<%=path%>/images/pic_gwc__r2_c2.jpg">
            </DIV>
                            ...
                            <tr>
                                ...
                                <td class="tb2_td7" align="center">
                                    <a href="<%=path%>/trolley/deleteTolleyItem/${merShowInfo.trolleyitemid}"
                                       id="deleteMer" onclick="del()" style=";font-weight: bold;">删除</a><br/><br/>
                                </td>
                            </tr>
                        </table>
