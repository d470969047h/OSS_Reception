...
<div id="box">
    ...
    <c:forEach items="${memberAddrList}" var="addrInfo">
        <h4 align="left"><span class="reusableColor3 letterSpac">收货人</span><span
                class="reusableColor3 letterSpac1">：</span>${addrInfo.recman}<br/>
                <%--<span class="reusableColor3">地　　区：</span>${addrInfo.recaddress}<br />--%>
            <span class="reusableColor3">收货地址：</span>${addrInfo.recaddress}<br/>
            <span class="reusableColor3">邮政编码：</span>${addrInfo.postcode}<br/>
            <span class="reusableColor3">联系方式：</span>${addrInfo.tel}</h4>
    </c:forEach>
      </span></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="typeTd2"><span class="addDeleteSty addFontCol"><a href="#"><span class="addFontCol">修改</span></a><span
                                ...
                                href="<%=path%>/order/order"><img src="<%=path%>/images/button_qr.gif" border="0"
                                                                  onclick="#"/></a></span><br/>
                        </td>
                    </tr>
                    <tr>
