    ...
    <script type="text/javascript">
        $(function () {
            $("#random").click(function () {
                document.getElementById("Img1").src = "<%=path%>/reg/validCode?r=" + Math.random();
            });
        });
    </script>
...
<div id="box">
    <!--top start -->
    <div id="top">
        <a href="<%=path%>/index/index"><img src="<%=path%>/images/logo.gif" alt="Estimation" width="255"
    ...
    <div id="body">
        <div id="Login">
            ...
            <form:form action="${ctx}/reg/userReg" method="post" modelAttribute="member">
                <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="lineJL">
                    ...
                    <tr>
                        ...
                        <td class="sty04" valign="top" width="425" align="left">　请填写有效的 Email地址作，我们会给这个地址发送您的帐户信息、订单通知等。
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="sty02" colspan="2" valign="top"><input name="validCode" id="Validate_Code"
                                                                          ...
                                                                          type="text"><img id="Img1"
                                                                                           ...
                                                                                           src="<%=path%>/reg/validCode"
                                                                                           onclick="this.src='/reg/validCode?r='+Math.random()"
                                                                                           border="0"> <span
                    ...
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <input type="submit"
                                   style="width:91px; height:25px; border:0; background-image: url(<%=path%>/images/submit.gif)"
                                   value=""/>
                        </td>
                        <td></td>
