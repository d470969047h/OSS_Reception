...
<head>
    ...
    <link type="text/css" href="<%=path%>/css/addressTo.jsp" rel="stylesheet"/>
    <script type="text/javascript" src="<%=path%>/js/jquery.js"></script>
    <script type="text/javascript" src="<%=path%>/js/jquery-1.9.1.js"></script>
    <script type="text/javascript" src="<%=path%>/js/liandong.js"></script>
    <script type="text/javascript" src="<%=path%>/js/addressTo.js"></script>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" class="addDivTab tabSty01">
            ...
            <tr>
                <td align="left" valign="top" height="145">
                    <div id="similar" class="changeAdd" align="center">
                        <ul>
                            <c:forEach items="${memberAddrList}" var="addrInfo">
                                <li>
                                    <p class=${true==addrInfo.isdefault?'selected':'common'}>
                                        <span style="color: red">寄送至</span>
                                        <input type="radio" ${true==addrInfo.isdefault?'checked="checked"':null}
                                               value="0" name="rd">${addrInfo.recaddress} (${addrInfo.recman}
                                        收) ${addrInfo.tel}
                                        <a href="${ctx}/address/updateDefaultAddr/${addrInfo.id}">设为默认地址</a>
                                        <a>修改</a> <a>删除</a>
                                    </p>
                                </li>
                            </c:forEach>
                    ...
                    <ul>
                        <li>
                                <span class="addSpanSty">
                                    <a href="<%=path%>/address/conAddress/"><img
                                            src="<%=path%>/images/button_pszADd.gif" border="0" onclick=""/></a>
                                </span>
                        </li>
                    </ul>
