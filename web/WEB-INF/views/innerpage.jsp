            ...
            <form:form action="${ctx}/trolley/addToTrolley" method="post" modelAttribute="merInfo">
                <div class="pro_price">
                    <dl>
                        ...
                        <div class="jqzoom" style='margin-right:5px;'><img src="<%=path%>/${merInfo.picpath}"
                                                                           width="320" height="320"
                                                                           alt="shoe"
                                                                           jqimg="<%=path%>/${merInfo.picpath}"></div>
                        </dt>
                        <dd>
                            ...
                            <table height="413" border="1" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td valign="top" align="middle" width="323" colspan="2"
                                        height="30"><font
                                            color="#bb1213"
                                            style=" font-size:24px; font-weight:bold;"><strong><form:label
                                            path="merchandisename">
                                ...
                                <tr>
                                    <td valign="top" align="right" width="111"
                                        height="28" style=" font-size:12px;color:#666; font-weight:bold;">原&nbsp;&nbsp;&nbsp;
                                        价：
                                    </td>
                                ...
                                <tr>
                                    <td valign="top" align="right" width="111"
                                        height="28" style=" font-size:14px;color:#666; font-weight:bold;">规&nbsp;&nbsp;&nbsp;
                                        格：
                                    </td>
                                    <td valign="top" width="212" height="28"
                                        style=" font-size:14px;">${merInfo.spec}</td>
                                </tr>
                                <tr>
