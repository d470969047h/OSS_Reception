...
<div id="box">
    ...
    <div id="body">
        <div id="Login">
            <h1 align="left" style="width:490px;"><span class="h1"><img src="<%=path%>/images/buttonPassword.gif" alt="找回密码" /></span></h1>
            <div class="Emai">
                <div class="dlTitle">
                </div>
                <div class="dlContent">
                    <div class="dlContentC">
                        ...
                        <p class="pSty1B" align="right"><a href="GetPwd2.html"><img src="<%=path%>/images/button_next.gif" border="0" /></a></p>
