...
.gwc_tb1{ width:100%; border-top:5px solid #48b9e5; background:#F8FAFC; height:38px; overflow:hidden;}
.tb1_td1{ width:35px;}
.tb1_td3{ width:290px; text-align:center; }
.tb1_td4{ width:240px; text-align:center; }
.tb1_td5{ width:115px; text-align:center; }
.tb1_td6{ width:140px; text-align:center; }
.tb1_td7{ text-align:center;}


.gwc_tb2{ width:100%; margin-top:20px; background:#F8FAFC; border:1px solid #e5e5e5;}
.tb2_td1{ width:60px; text-align:center;margin-left: -70px;}
.tb2_td2{ width:365px; text-align:center;padding-left:300px;}
