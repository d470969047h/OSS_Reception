...
.nav ul {
    background: url(<%=request.getContextPath()%>/images/nav01.jpg) 0 0 repeat-x;
    height: 37px;
    line-height: 37px;
}
...
.nav ul li.first {
    background: url(<%=request.getContextPath()%>/images/border.gif) 0 0 no-repeat;
}

.nav ul li.last {
    float: right;
    background: url(<%=request.getContextPath()%>/images/border.gif) right top no-repeat;
    padding-right: 10px;
    color: #c00;
    border-right: none;
}
...
.recommend {
    padding: 20px;
    padding-top: 8px;
    background: url(<%=request.getContextPath()%>/images/what_our_policy.gif) right bottom no-repeat;
    border: #f8b923 1px solid;
}
...
.recommend h2 {
    ...
    padding-left: 55px;
    background: url(<%=request.getContextPath()%>/images/top_bgc.gif) 0 0 no-repeat;
    margin-right: 260px;
}
...
.viv1 {
    ...
    display: block;
    float: left;
    background: url(<%=request.getContextPath()%>/images/vivioow_b1.jpg) 0 0 no-repeat;
    color: #fff;
    font-weight: bold;
    text-align: center;
}
